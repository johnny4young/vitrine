...
readonly identifier_pattern='C''S-?[0-9]{3}|ENG-[0-9]+|Phase[0-9]|phase[0-9]|Product Phase|Architecture [A-Z]|deep-review|analysis §|audit (UX|Perf|S|I|A)-?[0-9]+|P[0-9]+-(UX|Perf|Security)-[0-9]+|WOW[ -]?#[0-9]+|(Feature|Features|Decision|PR) ?#[0-9]+|\*\*Acceptance:\*\*|Acceptance criteria'
