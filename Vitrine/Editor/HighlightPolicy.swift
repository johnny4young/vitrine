...
enum HighlightMode: Equatable {
    ...
    nonisolated var usesPlainTextFallback: Bool {
...
enum HighlightPolicy {
    ...
    nonisolated static let maximumHighlightedByteCount = 128 * 1024
    ...
    nonisolated static let maximumCacheableByteCount = 32 * 1024
    ...
    nonisolated static let perRepresentationCostLimit = 4 * 1024 * 1024
    ...
    nonisolated static func mode(for code: String, language: Language) -> HighlightMode {
    ...
    nonisolated static func shouldCache(_ code: String) -> Bool {
    ...
    nonisolated static func editorDebounce(for code: String) -> Duration {
        shouldCache(code) ? .milliseconds(100) : .milliseconds(250)
    }

    nonisolated static func previewDebounce(for code: String) -> Duration {
    ...
    nonisolated static func cacheCost(
    ...
    nonisolated static func byteCount(of code: String) -> Int { code.utf8.count }
}
