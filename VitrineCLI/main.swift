...
do {
    ...
    // Entitlement stays at the process boundary. The constrained terminal-capture
    // command generated by `vgrab` is free; general rendering, multi-size, and batch
    // remain PRO and re-verify the app's signed activation token offline.
    if options.command.requiresPro, !CLIEntitlement.isProUnlocked() {
