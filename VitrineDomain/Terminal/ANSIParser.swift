...
public enum ANSIParser {
    ...
    public static func containsANSI(_ text: String) -> Bool {
    ...
    public static func hasPrivateParameterPrefix(_ params: String) -> Bool {
    ...
    public static func isStringSequenceIntroducer(_ scalar: Unicode.Scalar) -> Bool {
    ...
    public static func skipStringSequence(_ scalars: [Unicode.Scalar], from start: Int) -> Int {
        var cursor = start
    ...
    public static func hyperlinkURI(fromOSC body: String) -> String? {
    ...
    public static func applySGR(_ params: String, to style: ANSIStyle) -> ANSIStyle {
        var style = style
