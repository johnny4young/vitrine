...
/// crash the app".
public struct StylePresetDocument: Codable, Equatable, Sendable {
    ...
    public static let formatMarker = "vitrine.style-presets"
    ...
    public static func presets(from data: Data) throws -> [StylePreset] {
