...
public enum LocalSearch {
    ...
    public nonisolated static func fold(_ value: String, locale: Locale = .current) -> String {
        value.folding(
    ...
    public nonisolated static func terms(in query: String, locale: Locale = .current) -> [String] {
    ...
    public nonisolated static func matchesAllTerms(
