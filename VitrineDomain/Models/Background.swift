...
public enum BackgroundStyle: Sendable {
    ...
    public var diagnosticsKind: String {
        switch self {
        case .solid: "solid"
...
public enum GradientPreset: String, CaseIterable, Identifiable, Codable, Sendable {
    case aurora = "Aurora"
    case ocean = "Ocean"
    case sunset = "Sunset"
    case forest = "Forest"
    ...
    public var stopColors: [RGBAColor] {
    ...
    public var asCustomGradient: CustomGradient {
...
public struct GradientStop: Codable, Identifiable, Sendable {
    public let id: UUID
    ...
    public init(id: UUID = UUID(), color: RGBAColor, location: Double) {
        self.id = id
        self.color = color
...
public struct CustomGradient: Equatable, Hashable, Codable, Sendable {
    ...
    public init(stops: [GradientStop], angle: Double) {
    ...
    public static let `default` = CustomGradient(
        stops: [
    ...
    public var stopsSortedByLocation: [GradientStop] {
...
public enum BackgroundFit: String, CaseIterable, Identifiable, Codable, Sendable {
...
public struct ImageBackground: Equatable, Hashable, Codable, Sendable {
    ...
    public static let blurRange = 0.0...40.0
    public static let dimmingRange = 0.0...1.0
...
public struct ImageReference: Equatable, Hashable, Codable, Sendable {
