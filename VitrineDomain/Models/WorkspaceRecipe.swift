...
public struct WorkspaceRecipe: Codable, Equatable, Sendable {
    ...
    public var customTheme: StoredCustomTheme?
    ...
    public struct Metadata: Codable, Equatable, Sendable {
        ...
        public var header: SnapshotMetadata

        public init(windowTitle: String? = nil, header: SnapshotMetadata = SnapshotMetadata()) {
    ...
    public struct Output: Codable, Equatable, Sendable {
        public var destinationPresetID: String?
    ...
    public struct CanvasSize: Codable, Equatable, Sendable {
        ...
        public static let dimensionRange = 64...2_048
...
public struct WorkspaceRecipeDocument: Codable, Equatable, Sendable {
    public static let formatMarker = "vitrine.workspace-recipe"
    public static let currentSchemaVersion = 1

    public var format: String
    public var schemaVersion: Int
    public var recipe: WorkspaceRecipe

    public init(recipe: WorkspaceRecipe) {
    ...
    public func validatedJSONData() throws -> Data {
        do {
    ...
    public static func recipe(from data: Data) throws -> WorkspaceRecipe {
        let root: [String: Any]
        do {
            guard
