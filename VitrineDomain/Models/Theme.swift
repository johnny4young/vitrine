...
public struct Theme: Identifiable, Hashable, Sendable {
    ...
    public enum Appearance: String, Hashable, Sendable, Codable {
        case dark, light
    }
    ...
    public nonisolated init(id: String, displayName: String, palette: ThemePalette) {
        self.id = id
        self.displayName = displayName
    ...
    public nonisolated static let builtIns: [Theme] = [
    ...
    public nonisolated static let builtInIDs: Set<String> = Set(builtIns.map(\.id))
    ...
    public nonisolated static var all: [Theme] { builtIns }
    ...
    public nonisolated static func theme(withID id: String) -> Theme {
...
public struct ThemePalette: Hashable, Sendable, Codable {
    ...
    public nonisolated var appearance: Theme.Appearance {
    ...
    public var highlightJSStylesheet: String {
        var rules: [String] = [
...
public struct HexColor: Hashable, Sendable {
    ...
    public static let black = HexColor(red: 0, green: 0, blue: 0, alpha: 1)
    ...
    public nonisolated var relativeLuminance: Double {
