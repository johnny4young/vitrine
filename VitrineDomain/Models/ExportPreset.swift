...
extension ExportPreset {
    ...
    public static let keynote = ExportPreset(
        id: "keynote",
        displayName: "Keynote",
    ...
    public static let docs = ExportPreset(
        id: "docs",
    ...
    public static let transparentSlide = ExportPreset(
    ...
    public static let openGraph = ExportPreset(
        id: "opengraph",
    ...
    public static let githubBanner = ExportPreset(
        id: "github-banner",
