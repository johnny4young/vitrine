...
public enum SettingsSchema {
    ...
    public static let versionKey = "settingsSchemaVersion"
    ...
    ///   and logging).
    @discardableResult
    public static func migrateToCurrent(_ defaults: UserDefaults) -> Int {
    ...
    public static func migrate(defaults: UserDefaults, from: Int, to: Int) {
        if from < to {
...
public enum SettingsDefaults {
    /// Default code font family shared by portable styles and the AppKit font adapter.
    public static let fontName = "JetBrains Mono"

    /// Allowed export resolution multipliers (Output pane).
    public static let exportScaleRange = 1...3
    public static let exportScale = 2

    /// Font-size slider bounds (Style pane), in points.
    public static let fontSizeRange = 10.0...20.0
    public static let fontSize = 14.0

    /// Padding slider bounds (Style pane), in points.
    public static let paddingRange = 16.0...64.0
    ...
    public static let cornerRadiusRange = 0.0...48.0
    ...
    public static let wrapColumnsRange = 40...200
    public static let wrapColumns = 80

    public static func clampExportScale(_ value: Int) -> Int {
    ...
    public static func clampWrapColumns(_ value: Int) -> Int {
    ...
    public static var wrapColumnsSliderRange: ClosedRange<Double> {
    ...
    public static func clampPadding(_ value: Double) -> Double {
        clamp(value, to: paddingRange, fallback: padding)
    }

    public static func clampCornerRadius(_ value: Double) -> Double {
    ...
    public static func clampShadowRadius(_ value: Double) -> Double {
        clamp(value, to: shadowRadiusRange, fallback: shadowRadius)
    }
