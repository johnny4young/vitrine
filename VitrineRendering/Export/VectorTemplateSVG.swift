...
public enum VectorTemplateSVG {
    ...
    public static func background(
        _ background: VitrineDomain.BackgroundStyle, size: CGSize
    ) -> String? {
    ...
    public static func supports(_ background: VitrineDomain.BackgroundStyle) -> Bool {
