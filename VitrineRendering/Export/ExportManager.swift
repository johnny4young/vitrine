...
public enum ExportManager {
    ...
    public static func renderCGImageChecked(
        _ config: SnapshotConfig, scale: CGFloat = 2, fixedSize: CGSize? = nil,
        profile: ColorProfile = .sRGB,
        budget: RenderBudget = .export,
        backgroundImageStore: BackgroundImageStore = .container,
    ...
    public static func renderCGImageChecked<Content: View>(
        _ content: Content,
        proposedSize: CGSize?,
        scale: CGFloat,
        ...
        case .failure(let error):
            RenderingLog.render.error("Raster render rejected or failed")
            throw error
        case nil:
            RenderingLog.render.error("Raster render produced no image")
            throw .allocationFailed
        }
    }
    ...
    public static func normalized(_ cgImage: CGImage, to profile: ColorProfile) -> CGImage {
        guard let colorSpace = profile.cgColorSpace else {
            RenderingLog.render.error("Color space unavailable; exporting render untagged")
            return cgImage
        }
        ...
        guard
            ...
            RenderingLog.render.error("Color context creation failed; exporting render untagged")
            return cgImage
        }
    ...
    private static func compositedOverBlackChecked(_ cgImage: CGImage) -> CGImage? {
        guard
            ...
            RenderingLog.render.error("Opaque image-background context creation failed")
            return nil
        }
    ...
    public static func renderNSImage(
        _ config: SnapshotConfig, scale: CGFloat = 2, fixedSize: CGSize? = nil,
        profile: ColorProfile = .sRGB,
        budget: RenderBudget = .export,
        backgroundImageStore: BackgroundImageStore = .container,
    ...
    public static func renderNSImageChecked(
        _ config: SnapshotConfig, scale: CGFloat = 2, fixedSize: CGSize? = nil,
        profile: ColorProfile = .sRGB,
        budget: RenderBudget = .export,
        backgroundImageStore: BackgroundImageStore = .container,
    ...
    nonisolated public static func pngData(from cgImage: CGImage) -> Data? {
    ...
    nonisolated public static func heicData(from cgImage: CGImage) -> Data? {
        lossyImageData(
    ...
    nonisolated public static func avifData(from cgImage: CGImage) -> Data? {
    ...
    public static func encodedPayloadChecked(
    ...
    nonisolated public static func rasterData(from cgImage: CGImage, format: ExportFormat) -> Data?
    {
        switch format {
    ...
    nonisolated public static func rasterMetadata(
    ...
    nonisolated public static var avifContentType: UTType {
