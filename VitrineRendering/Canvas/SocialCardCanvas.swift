...
public struct SocialCardCanvas: View {
    public let model: SocialCardModel
    ...
    public var size: CGSize = SocialCardModel.defaultSize

    public init(model: SocialCardModel, size: CGSize = SocialCardModel.defaultSize) {
        self.model = model
        self.size = size
    }
