...
public enum CodeFont {
    ...
    public static let system: [String] = ["SF Mono", "Menlo", "Monaco"]

    /// All selectable fonts, bundled first.
    public static let all: [String] = bundled + system

    public static let `default` = SettingsDefaults.fontName
    ...
    /// on or off.
    public static func resolved(family: String, size: CGFloat, ligatures: Bool) -> NSFont {
    ...
    public static func applyingLigatures(_ enabled: Bool, to font: NSFont) -> NSFont {
    ...
    public static func advance(of character: Character, in font: NSFont) -> CGFloat {
    ...
    public static let nerdFontCandidates: [String] = [
    ...
    public static func installedNerdFonts(
    ...
    public static func applyingNerdCascade(to font: NSFont) -> NSFont {
    ...
    public static func applying(cascade descriptors: [NSFontDescriptor], to font: NSFont) -> NSFont
    {
