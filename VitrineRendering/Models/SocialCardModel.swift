...
public struct SocialCardModel: Equatable {
    ...
    public var template: SocialCardTemplate
    ...
    public static let defaultSize = CGSize(width: 1200, height: 630)
    ...
    public static let maxExcerptLines = 8
    ...
    public static let fontSizeRange = 14.0...40.0

    /// The default excerpt size when none is specified.
    public static let defaultFontSize = 22.0
...
public enum SocialCardTemplate: String, CaseIterable, Identifiable, Codable, Sendable {
