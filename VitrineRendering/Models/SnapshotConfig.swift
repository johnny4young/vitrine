...
public struct SnapshotConfig: Equatable {
    public init() {}

    /// Creates a snapshot from source text while retaining every presentation default.
    /// This focused initializer keeps call sites concise without exposing the full model as
    /// one fragile, ever-growing memberwise initializer across the rendering-module boundary.
    ...
    public var theme: Theme = .oneDark
    ...
    public var fontLigatures: Bool = false
    public var padding: Double = 32
    public var background: BackgroundStyle = .gradient(.aurora)
    public var showChrome: Bool = true
    ...
    public var cornerRadius: Double = 8
    public var shadowRadius: Double = Self.defaultShadowRadius
    ...
    public static let defaultShadowRadius: Double = 20
    ...
    public var focusHighlightedLines: Bool = false
    ...
    public var diffDecorations: Bool = false
    ...
    public var foregroundImage: ImageReference?
    ...
    public var imageFrame: ImageFrame = .none
    ...
    public var imageFrameAppearance: FrameAppearance = .auto
    ...
    public var wrapsLongLines: Bool { wrapColumns != nil }

    /// The shadow radius to draw, honoring the `showShadow` toggle.
    public var effectiveShadowRadius: Double { showShadow ? shadowRadius : 0 }
    ...
    public var usesImageContent: Bool { foregroundImage != nil }
    ...
    public var hasRenderableContent: Bool { usesImageContent || !code.isEmpty }
    ...
    public static let redactedLinePlaceholder = "[redacted]"
...
public struct Watermark: Equatable {
    ...
    public var logoIdentity: String?
    ...
    public var placement: Placement = .bottomTrailing
    ...
    public var freePosition: CGPoint = CGPoint(x: 0.84, y: 0.9)
    ...
    public static func clampFreePosition(_ point: CGPoint) -> CGPoint {
        CGPoint(x: min(max(point.x, 0), 1), y: min(max(point.y, 0), 1))
    }

    /// Whether the mark has anything to draw — a logo, a non-empty line, or a QR chip.
    public var hasContent: Bool { logoImageData != nil || !text.isEmpty || qrImage != nil }

    public init(
        text: String,
        logoImageData: Data? = nil,
        logoImage: NSImage? = nil,
        logoIdentity: String? = nil,
        tint: RGBAColor? = nil,
        placement: Placement = .bottomTrailing,
        freePosition: CGPoint = CGPoint(x: 0.84, y: 0.9),
        qrImage: NSImage? = nil,
        qrIdentity: String? = nil
    ) {
        self.text = text
        self.logoImageData = logoImageData
        self.logoImage = logoImage
        self.logoIdentity = logoIdentity
        self.tint = tint
        self.placement = placement
        self.freePosition = Self.clampFreePosition(freePosition)
        self.qrImage = qrImage
        self.qrIdentity = qrIdentity
    }
