...
const TICKETS = [
  ...
  { id: "CS-002", objective: "Configurable global hotkey whose action (quick capture vs open editor) is user-selectable.", files: "Vitrine/Models/GlobalShortcuts.swift, Vitrine/App/AppDelegate.swift, Vitrine/Settings/AppSettings.swift, Vitrine/Settings/SettingsPanes.swift" },
  ...
  { id: "CS-004", objective: "Language auto-detect (weighted scoring, Go not misread as Swift), manual picker, recents-first order.", files: "Vitrine/Editor/LanguageDetector.swift, Vitrine/Settings/AppSettings.swift (recentLanguages/orderedLanguages), Vitrine/Editor/EditorView.swift" },
  ...
  { id: "CS-006", objective: "Customization: theme, padding(16-64), font size(10-20), background, chrome toggle, shadow toggle.", files: "Vitrine/Settings/SettingsPanes.swift, Vitrine/Models/SnapshotConfig.swift (showShadow/effectiveShadowRadius)" },
  ...
  { id: "CS-008", objective: "macOS Share Sheet wired into the editor toolbar.", files: "Vitrine/Export/ShareManager.swift, Vitrine/Editor/EditorView.swift, Vitrine/Export/ExportManager.swift (renderNSImage)" },
  ...
  { id: "CS-010", objective: "Settings window with General/Style/Output/Input/About panes and a live preview in Style.", files: "Vitrine/Settings/SettingsWindow.swift, Vitrine/Settings/SettingsPanes.swift" },
  ...
  { id: "CS-014", objective: "Launch at login via SMAppService (not deprecated SMLoginItemSetEnabled).", files: "Vitrine/Settings/LaunchAtLogin.swift, Vitrine/Settings/SettingsPanes.swift" },
