...
requireText(english, 'Basic terminal capture is now free.', 'Release highlight');
...
requireText(siteScript, 'La captura básica de terminal ahora es gratuita.', 'Spanish release highlight');
