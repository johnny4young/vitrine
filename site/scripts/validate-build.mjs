...
requireText(english, 'Extreme renders fail safely.', 'Release highlight');
...
requireText(siteScript, 'Los renderizados extremos fallan de forma segura.', 'Spanish release highlight');
