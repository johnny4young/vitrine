...
requireText(english, 'Free terminal capture and search move forward together.', 'Release highlight');
...
requireText(english, 'There is <strong>no expiring trial</strong>', 'No-expiry evaluation policy');
requireText(english, 'Homebrew and the signed, notarized DMG are the canonical channels.', 'Canonical distribution policy');
...
requireText(siteScript, 'La captura gratuita de terminal y la búsqueda avanzan juntas.', 'Spanish release highlight');
...
requireText(readme, 'There is **no expiring trial**', 'README no-expiry evaluation policy');
