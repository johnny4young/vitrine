/* localStorage is blocked in some sandboxed preview iframes — reading/writing it
  ...
  (function () {
    var ES = {
      ...
      "more.c2h": "Exporta y comparte", "more.c2p": "PNG/PDF retina al portapapeles, a archivo o al menú Compartir. Abre un archivo en vivo solo durante la sesión, exporta una receta de workspace sin rutas en Ajustes, asóciala localmente con una carpeta o pásala explícitamente a la CLI <code>vitrine</code>.",
      ...
      "cl.version": "Versión", "cl.headline": "Más estable donde importa",
      "cl.h1": "<strong>Reabrir una ventana recupera el documento completo.</strong> La restauración conservaba el estilo pero perdía parte del contenido; ya no, y se cerraron dos fallos que ocurrían en esa misma ruta.",
      "cl.h2": "<strong>Las capturas de terminal son más fieles.</strong> Una pantalla limpiada queda limpia, las secuencias de control que tu terminal oculta siguen ocultas y las aplicaciones de pantalla completa se ven como se ven.",
      "cl.h3": "<strong>Tu estilo viaja completo.</strong> La profundidad de la sombra ahora acompaña al resto de los valores en los estilos guardados, las recetas y las sesiones restauradas.",
      "cl.h4": "<strong>Las exportaciones por lotes ya no se sobrescriben entre sí.</strong> Dos nombres que solo se diferenciaban en mayúsculas resolvían al mismo archivo en macOS; ahora cada salida se reserva antes de escribir nada.",
      ...
      "inst.lead": "Instala con Homebrew para añadir la app y la CLI a tu PATH, o descarga el DMG firmado y notarizado. En una instalación desde DMG puedes activar la CLI desde Ajustes.",
